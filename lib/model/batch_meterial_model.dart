...
class BatchMaterialRespopnseModel {
    ...
    factory BatchMaterialRespopnseModel.fromRawJson(String str) => BatchMaterialRespopnseModel.fromJson(json.decode(str));

    String toRawJson() => json.encode(toJson());

    factory BatchMaterialRespopnseModel.fromJson(Map<String, dynamic> json) => BatchMaterialRespopnseModel(
        materials: json["materials"] == null ? null : List<BatchMaterialModel>.from(json["materials"].map((x) => BatchMaterialModel.fromJson(x))),
    );

    Map<String, dynamic> toJson() => {
        "materials": materials == null ? null : List<dynamic>.from(materials.map((x) => x.toJson())),
    };
}
...
class BatchMaterialModel {
    ...
    factory BatchMaterialModel.fromJson(Map<String, dynamic> json) => BatchMaterialModel(
        ...
        fileType: json["file"] == null ? null : json["file"].split("/").last.split(".").last,
        isPrivate: json["isPrivate"] == null ? null : json["isPrivate"],
        fileUploadedOn: json["fileUploadedOn"] == null ? null : json["fileUploadedOn"],
